...
> 마지막 업데이트: 2026-05-03 (랜딩 페이지, 집중 모드, 글자 크기, 전체 내보내기, 작품 설명 수정, 통계 바, NovelCard 리디자인, 글쓰기 통계 페이지, 일별 작성량 자동 기록, AI 글쓰기 보조, 작품 검색, 회차 복사)
...
- 작품 검색 인풋 — 제목·설명 포함 실시간 필터링 (작품이 1개 이상일 때 표시)
- 작품 생성 폼 (제목 + 설명)
- 작품 목록 (3열 그리드)
